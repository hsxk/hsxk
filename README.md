...
<img src="https://skillicons.dev/icons?i=ts,js,react,nextjs,vue,python,go,php,laravel,postgres,redis,docker,aws,nginx,cloudflare,githubactions&perline=8" alt="Technology stack" />

</div>

| Area | I work with |
| --- | --- |
| **Frontend** | React, Next.js, Vue, TypeScript, SSR/ISR, i18n, responsive UI |
| **Backend** | Python, FastAPI, Django, Flask, Go, PHP, Laravel, WordPress |
| **Data** | PostgreSQL, Redis, XBRL, disclosure pipelines, search, data modeling |
| **Infrastructure** | Docker, Nginx, AWS, Cloudflare, GitHub Actions, observability |
| **Product engineering** | UI/UX, performance, accessibility, SEO, multilingual product design |
